...
%%
program : protocol declarations knowledge actions goals authenticity end
        ;
...
authenticity : AUTHENTICITY { printf("/*Authenticity*/ \n"); } /*authenticity*/_list
      ;

/*authenticity*/_list : /* empty */
           | /*authenticity*/_list/*authenticity*/_entry
           ;

/*authenticity*/_entry :  ID  ID  ID  ID ID ID ID ID { printf("    %s %s authenticates %s %s %s;\n", $2, $3, $6, $7,$8);}
           ;
